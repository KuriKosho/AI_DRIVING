...
# dataset paths
train_data_path = r"../Data/Dataset/train"
validation_data_path = r"../Data/Dataset/validation"

# define an image generator to format images before using them
train_data_generator = tf.keras.preprocessing.image.ImageDataGenerator(horizontal_flip=True, rescale=1./255, zoom_range=0.2, validation_split=0.1)
...
# summarize the model
with open("../Data/Model/model_summary.txt", "w",encoding="utf-8") as file:
...
model_path = "../Data/Model/yawn_detect.keras"
